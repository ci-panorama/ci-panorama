...
import static fr.elecomte.ci.look.services.badges.ImageUtils.*;
import static fr.elecomte.ci.look.services.badges.ImageUtils.getImageTypeFromBase64Uri;
import static fr.elecomte.ci.look.services.badges.ImageUtils.loadBase64Uri;
import static fr.elecomte.ci.look.services.badges.ImageUtils.resizeImage;
...
public class DeveloperListProvider extends BadgeValueProvider<List<Developer>> {
	...
	/**
	 * @return
	 * @see fr.elecomte.ci.look.services.badges.providers.BadgeValueProvider#isLogo()
	 */
	@Override
